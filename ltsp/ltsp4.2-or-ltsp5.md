...
Good luck sorting *that* little problem out, for myself I upgraded to LTSP5 (see [LTSP5 Upgrade](/ltsp/upgrade/)) and I have never looked back.  The client is up-to-date and configurable, the local devices work, sound works, and little fluffy bunny rabbits nibble the grass while the sun shines.
